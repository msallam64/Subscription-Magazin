...
export default class CustomLookup extends LightningElement {
    ...
    handleKeyChange(event) {
        ...
        this.delayTimeout = setTimeout(() => {
            this.searchKey = searchKey; // update the searchKey after debounce
            console.log('Search Key updated:', this.searchKey);
        }, DELAY);
    }
    ...
    handelSelectedRecord(event) {
        ...
        if (this.selectedRecord) {
            ...
            this.lookupUpdatehandler(this.selectedRecord); // update value on parent component
            this.handelSelectRecordHelper(); // helper function to show/hide lookup result container on UI
        } else {
            console.error("No matching record found for Id:", objId);
        }
    }
    ...
    handelSelectRecordHelper() {
        ...
        if (this.selectedRecord && this.selectedRecord.Name) {
            ...
            console.error("Selected record is empty or invalid:", this.selectedRecord);
        }
    }
    // send selected lookup record to parent component using custom event
    lookupUpdatehandler(value) {
        console.log('Dispatching selected record:', value);
